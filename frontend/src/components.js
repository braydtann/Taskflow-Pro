        ...
        {activeTab === "calendar" && (
          <div className="calendar-placeholder">
            <div className="placeholder-content">
              <svg fill="currentColor" viewBox="0 0 24 24" className="placeholder-icon">
                <path d="M9 11H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2zm2-7h-1V2h-2v2H8V2H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z"/>
              </svg>
              <h3>Calendar View</h3>
              <p>Calendar integration coming soon! Tasks will be displayable in a beautiful calendar interface.</p>
            </div>
          </div>
        )}
      </div>
